...
<div class="container-fluid">
    <div style="text-align: center">
        <form action="/user-update" method="post" style="width: 400px; display: inline-block; text-align: left;">
            <input hidden type="text" class="form-control" id="id" name="id" value="${user.id}">
