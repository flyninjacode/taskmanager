...
<div class="container-fluid">
    <div style="text-align: center">
        <form action="/task-create" method="post" style="width: 400px; display: inline-block; text-align: left;">
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <label class="input-group-text" for="projectId">Options</label>
                </div>
                <select class="custom-select" id="projectId" name="projectId">
