...
<div class="container-fluid">
    <div class="my-2" style="text-align: center">
        <c:if test="${not empty tasks}">
            <table class="table table-striped table-sm table-responsive-md">
                ...
                <tr>
                    ...
                    <th scope="col">
                        <div>Status Type</div>
                        <div>
                            <a href="/task-list-status-asc-all">ASC</a>
                            <a href="/task-list-status-desc-all">DESC</a>
                        </div>
                    </th>
                    <th scope="col">
                        <div>Start Date</div>
                        <div>
                            <a href="/task-list-start-date-asc-all">ASC</a>
                            <a href="/task-list-start-date-desc-all">DESC</a>
                        </div>
                    </th>
                    <th scope="col">
                        <div>Finish Date</div>
                        <div>
                            <a href="/task-list-finish-date-asc-all">ASC</a>
                            <a href="/task-list-finish-date-desc-all">DESC</a>
                        </div>
                    </th>
            ...
            <form action="/task-search-all" method="get" class="form-inline my-2 my-lg-0">
