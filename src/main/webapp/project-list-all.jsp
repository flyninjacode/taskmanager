...
<div class="container-fluid">
    <div class="my-2" style="text-align: center">
        <c:if test="${not empty projects}">
            <table class="table table-striped table-sm table-responsive-md">
                ...
                <tr>
                    ...
                    <th scope="col">
                        <div>Status Type</div>
                        <div>
                            <a href="/project-list-status-asc-all">ASC</a>
                            <a href="/project-list-status-desc-all">DESC</a>
                        </div>
                    </th>
                    <th scope="col">
                        <div>Start Date</div>
                        <div>
                            <a href="/project-list-start-date-asc-all">ASC</a>
                            <a href="/project-list-start-date-desc-all">DESC</a>
                        </div>
                    </th>
                    <th scope="col">
                        <div>Finish Date</div>
                        <div>
                            <a href="/project-list-finish-date-asc-all">ASC</a>
                            <a href="/project-list-finish-date-desc-all">DESC</a>
                        </div>
                    </th>
            ...
            <form action="/project-search-all" method="get" class="form-inline my-2 my-lg-0">
